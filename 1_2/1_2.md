...
### 3. Editing a file in the terminal <a href="#editing_file" id="editing_file"></a>
...
### 5. Special configuration files in **Bash** <a href="#configuration-files" id="configuration-files"></a>
