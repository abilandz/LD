...
### 1. Command history search <a href="#command_history_search" id="command_history_search"></a>
...
### 2. Searching for files and directories: **find** and **locate** <a href="#find" id="find"></a>
...
*   `-not -path somePattern` &mdash; exclude from search all results which would match the pattern 'somePattern'. Example:
    ...
    With the above syntax, the search will be performed for files in all directories named 'someDir\_0', ... 'someDir\_9', with the exception of a directory named 'someDir\_4'.
...
### 3. Online monitoring: **tail -f** <a href="#tail" id="tail"></a>
...
### 4. Timing: **timeout** and **time** <a href="#timing" id="timing"></a>
...
### 5. Counting: **wc** <a href="#counting" id="counting"></a>
...
### 6. Building programmatically command input: **eval** <a href="#eval" id="eval"></a>
